          ...
          <div className="mt-2">
            <div className="border-2 border-dashed border-gray-300 rounded-md p-4 mb-3">
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-sm text-gray-500 mb-2">
                  {selectedFile ? selectedFile.name : 'Upload shapefile of assessment units'}
                </p>
                      ...
                      <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-72 bg-white shadow-lg rounded-md p-3 z-10 border border-gray-200">
                        <div className="text-xs">
                          ...
                          <table className="w-full border-collapse text-xs mb-2">
                            ...
                            <tbody>
                              <tr>
                                <td className="border border-gray-300 px-1 py-1">UNIT_ID</td>
                                <td className="border border-gray-300 px-1 py-1">The ID for the assessment unit (village id)</td>
                                <td className="border border-gray-300 px-1 py-1">string</td>
                              </tr>
                              <tr>
                                <td className="border border-gray-300 px-1 py-1">NAME1</td>
                                <td className="border border-gray-300 px-1 py-1">name of the assessment unit</td>
                                <td className="border border-gray-300 px-1 py-1">string</td>
                              </tr>
                            </tbody>
                          </table>
                          
                          <h4 className="font-semibold text-gray-800 mb-1">Required Time Series Format:</h4>
                          <p className="text-gray-600 mb-1">CSV file with time series data for each assessment unit.</p>
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-md p-4">
              <div className="flex flex-col items-center justify-center">
                <p className="text-sm text-gray-500 mb-2">
                  Upload CSV with demand time series data
                </p>
