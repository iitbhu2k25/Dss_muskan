...
const GroundwaterSustainability: React.FC<GroundwaterSustainabilityProps> = ({ activeTab }) => {
  ...
  return (
    <div className="h-full overflow-auto flex flex-col">
      ...
      <div className="mt-6">
        <h3 className="font-medium text-blue-600 mb-4">Sustainability Analysis</h3>
        
        <div className="mb-4">
          <label className="block text-sm font-medium text-gray-700 mb-1">Analysis Method</label>
          <select className="w-full p-2 border rounded-md text-sm">
            <option value="">Select Method...</option>
            <option value="water-budget">Water Budget Analysis</option>
            <option value="gw-index">Groundwater Sustainability Index</option>
            <option value="thresholds">Critical Thresholds Analysis</option>
          </select>
        </div>
        ...
        <div className="mb-4">
          <label className="block text-sm font-medium text-gray-700 mb-1">Spatial Aggregation</label>
          <select className="w-full p-2 border rounded-md text-sm">
            <option value="">Select Aggregation...</option>
            <option value="basin">Basin Level</option>
            <option value="subbasin">Sub-basin Level</option>
