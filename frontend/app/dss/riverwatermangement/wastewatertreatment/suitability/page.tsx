...
export default function SiteSuitabilityPage() {
  ...
  // Handle vector data display
  const handleDisplayVectors = (geoJsonData: Record<string, any>) => {
    setVectorData(geoJsonData);
  };
      ...
      case 1:
        return (
          <DataSelectionPart
            ...
            onDisplayVectors={handleDisplayVectors}
          />
        );
      case 2:
        return (
    ...
    <div className="container mx-5 mr-5 my-8 max-w-full">
      <div className="bg-white rounded-lg shadow-md">
          ...
          <div className="relative flex items-center justify-between max-w-3xl mx-auto mb-8">
            ...
            {[1, 2, 3].map((step) => (
              <div key={step} className="relative z-10">
                ...
                <div
                  className={`absolute mt-3 -ml-10 w-20 text-center space-y-1 ${
                    completedSteps.includes(step)
        ...
        <div className="flex flex-col md:flex-row gap-4 p-4 mt-8">
          {/* Left Section - Dynamic based on step - Now 55% width */}
          <div className="left-section w-full md:w-[55%]">{renderStepContent()}</div>

          {/* Right Section - Map stays consistent - Now 45% width */}
