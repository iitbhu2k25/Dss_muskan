...
// import { useLocation, Village, SubDistrict } from '@/app/contexts/LocationContext';
...
//   const handleVillagesChange = (selectedIds: string[]): void => {
//     if (!selectionsLocked) {
...
//         {/* Village Multiselect with population display */}
//         <MultiSelect
//           items={villages}
