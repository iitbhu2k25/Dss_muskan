...
import { LocationProvider } from "@/app/contexts/stp_sutability/LocationContext";
import { CategoryProvider } from "@/app/contexts/stp_sutability/CategoryContext";
import { MapProvider } from "@/app/contexts/stp_sutability/MapContext";
import LocationSelector from "@/app/dss/RWM/WWT/stp_sutability/components/locations";
import CategorySelector from "@/app/dss/RWM/WWT/stp_sutability/components/Category";
import { useLocation } from "@/app/contexts/stp_sutability/LocationContext";
import { useCategory } from "@/app/contexts/stp_sutability/CategoryContext";
import MapView from "@/app/dss/RWM/WWT/stp_sutability/components/openlayer";
import { useMap } from "@/app/contexts/stp_sutability/MapContext";
...
const MainContent = () => {
  ...
  const handleSubmit = () => {
    if (selectedCondition.length < 1) {
      ...
      setSubmitting(true);
      // let temp = [...selectedCondition, ...selectedConstraint];
      // const selectedData=temp.map((item) => {
      //   const { file_name, Influence, ...rest } = item;
      //   return {
      //     ...rest,
      //     raster_name: item.file_name,
      //   };
      // });
  ...
  // Update to use the correct function for the selected tab
  useEffect(() => {
    if (submitting) {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-6 shadow-lg">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold">Site Suitability</h1>
